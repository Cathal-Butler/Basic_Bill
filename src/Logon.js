...
class Logon extends Component {
  ...
  //Taking in what the user inputs into Email/Password input box
    ...
    return (
      <div className="form-signin" id="logon-bgimage">
        ...
        {this.state.showSignUp === true ? (
          //Wrap Signup component in a div so it can be hidden or shown using the ernary operator, if true, show it, else: :null (hide it)
          <div>
            <Signup />
          </div>
        ) : null}
