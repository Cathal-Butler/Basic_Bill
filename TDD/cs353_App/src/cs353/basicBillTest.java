...
public class basicBillTest {
	...
	static String url="https://h4pmp.csb.app/option2"; //Inserted CodeSandbox Project URL
	...
	public static void calculatorTestTemplate(String s1,String s2, String expectedAns){
	...
	public void validDataTests(String s1, String s2, String ans){
		basicBillTest.calculatorTestTemplate(s1,s2, ans);
	}
